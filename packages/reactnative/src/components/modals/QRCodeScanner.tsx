        ...
        if (cameraPermission === 'restricted') {
            ...
            try {
                ...
                if (newCameraPermission === 'granted') {
                    ...
                    toast.show("Camera permission denied. Go to your device settings to Enable Camera", { type: "warning" });
                    onClose();
                }
            } catch (error) {
                toast.show('Go to your device settings to Enable Camera', { type: 'normal', duration: 5000 });
                onClose();
            }
        } else {
            setIsCameraPermitted(true);
